...
% Auto-generated by MATLAB on 19-Nov-2024 08:47:54
...
predictorNames = {'F1', 'F2', 'F3'};
predictors = inputTable(:, predictorNames);
response = inputTable.vowel;
isCategoricalPredictor = [false, false, false];
classNames = {'a'; 'e'; 'i'; 'o'; 'u'; 'y'};
...
trainedClassifier.RequiredVariables = {'F1', 'F2', 'F3'};
