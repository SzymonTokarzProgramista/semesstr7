...
IMAQ         = 1; % w przypadku gdy interfejs webcam nie działa można użyć interfejsu imaq
                  % w tym celu należy ustawić zmienną IMAQ = 1 oraz
                  % odpowiednio zmienić parametry videoinput poniżej
if IMAQ==1
    %camera       = videoinput('winvideo', nrKamery, 'RGB_640x480');% ustawic odpowiedni nr kamery oraz rozdzielczosc
    camera       = videoinput('winvideo', nrKamery, 'YUY2_640x480');% ustawic odpowiedni nr kamery oraz rozdzielczosc
else
